...
function Switch({ onCheckedChange, checked, defaultChecked, ...props }: SwitchProps) {
  ...
  return (
    ...
    >
      <SwitchPrimitives.Root checked={checked} defaultChecked={defaultChecked} onCheckedChange={setIsChecked} asChild>
        <motion.button
          data-slot="switch"
          whileTap="tap"
          initial={false}
